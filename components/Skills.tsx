...
const Skills = (props: Props) => {
  return (
    ...
    className='h-screen relative flex flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-secreen justify-center xl:space-y-0 mx-auto items-center '>
